...
const ResourcesSection: React.FC = () => {
	...
	return (
		<div>
			<section className="2xl:h-screen py-20 px-5 bg-[#0B1219] to-10% flex flex-col justify-center items-center gap-10 md:gap-30">
				<div className="flex flex-col items-center">
					...
					<p className="text-center text-lg w-full sm:w-2/3 mt-8 px-6">
						SPUR is pioneering the next generation of sustainable, scalable AI
