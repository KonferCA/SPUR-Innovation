...
const InnovationFundSection: React.FC = () => {
    return (
        <div>
            <section className="relative px-10 xl:px-30 py-30 2xl:h-screen flex justify-center items-center bg-[radial-gradient(ellipse_120%_120%_at_0%_0%,_rgba(245,144,71,0.85),_transparent_70%)] bg-nearBlack">
                {/* Slide Deck Card */}
